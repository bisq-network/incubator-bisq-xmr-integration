...
public class XmrOfferDetailsWindow extends Overlay<XmrOfferDetailsWindow> {
    protected static final Logger log = LoggerFactory.getLogger(XmrOfferDetailsWindow.class);
    ...
    @Inject
    public XmrOfferDetailsWindow(BSFormatter formatter, User user, KeyRing keyRing,
    ...
    public void show(Offer offer, XmrCoin tradeAmount, Price tradePrice) {
        this.offer = offer;
    ...
    public XmrOfferDetailsWindow onPlaceOffer(Runnable placeOfferHandler) {
        this.placeOfferHandlerOptional = Optional.of(placeOfferHandler);
        return this;
    }

    public XmrOfferDetailsWindow onTakeOffer(Runnable takeOfferHandler) {
    ...
    private void addContent() {
        ...
        if (takeOfferHandlerOptional.isPresent()) {
            ...
            addConfirmationLabelLabel(gridPane, ++rowIndex, DisplayUtils.formatVolumeLabel(currencyCode) + fiatDirectionInfo,
                    DisplayUtils.formatVolumeWithCode(offer.getVolumeByAmount(Coin.valueOf(tradeAmount.value))));
        } else {
            addConfirmationLabelLabel(gridPane, ++rowIndex, btcAmount + btcDirectionInfo,
