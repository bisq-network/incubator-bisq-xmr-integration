...
import bisq.desktop.main.offer.xmr.OfferXmrDataModel;
 ...
 */
class TakeXmrOfferDataModel extends OfferXmrDataModel {
    ...
    @Inject
    TakeXmrOfferDataModel(TradeManager tradeManager,
