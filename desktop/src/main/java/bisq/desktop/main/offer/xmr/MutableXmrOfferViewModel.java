...
public abstract class MutableXmrOfferViewModel<M extends MutableXmrOfferDataModel> extends ActivatableWithDataModel<M> {
    ...
    @Inject
    public MutableXmrOfferViewModel(M dataModel,
