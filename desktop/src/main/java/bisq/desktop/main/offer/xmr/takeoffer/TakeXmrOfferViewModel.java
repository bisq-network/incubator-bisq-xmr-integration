...
class TakeXmrOfferViewModel extends ActivatableWithDataModel<TakeXmrOfferDataModel> implements ViewModel {
    final TakeXmrOfferDataModel dataModel;
    ...
    @Inject
    public TakeXmrOfferViewModel(TakeXmrOfferDataModel dataModel,
