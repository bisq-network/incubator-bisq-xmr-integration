...
@Singleton
@Slf4j
public class XmrOfferBook {
    private final OfferBookService offerBookService;
    private final ObservableList<XmrOfferBookListItem> offerBookListItems = FXCollections.observableArrayList();
    ...
    @Inject
    XmrOfferBook(OfferBookService offerBookService, TradeManager tradeManager) {
        ...
        offerBookService.addOfferBookChangedListener(new OfferBookService.OfferBookChangedListener() {
            ...
            public void onAdded(Offer offer) {
                ...
                if (!hasSameOffer) {
                    XmrOfferBookListItem offerBookListItem = new XmrOfferBookListItem(offer);
    ...
    public ObservableList<XmrOfferBookListItem> getOfferBookListItems() {
