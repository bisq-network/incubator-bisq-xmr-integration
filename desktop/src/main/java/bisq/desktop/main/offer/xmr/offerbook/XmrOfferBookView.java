...
package bisq.desktop.main.offer.xmr.offerbook;
...
import bisq.desktop.main.offer.xmr.XmrOfferView;
import bisq.desktop.main.offer.xmr.XmrOfferView.OfferActionHandler;
...
@FxmlView
public class XmrOfferBookView extends ActivatableViewAndModel<GridPane, XmrOfferBookViewModel> {
    ...
    private AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> amountColumn, volumeColumn, marketColumn,
            priceColumn, paymentMethodColumn, signingStateColumn, avatarColumn;
    private TableView<XmrOfferBookListItem> tableView;

    private XmrOfferView.OfferActionHandler offerActionHandler;
    private int gridRow = 0;
    private Label nrOfOffersLabel;
    private ListChangeListener<XmrOfferBookListItem> offerListListener;
...
//        titledGroupBg.getStyleClass().add("last");
    ...
    public void setOfferActionHandler(OfferActionHandler offerActionHandler) {
    ...
    private AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> getAmountColumn() {
        ...
        column.setCellFactory(
                new Callback<>() {
                    @Override
                    public TableCell<XmrOfferBookListItem, XmrOfferBookListItem> call(
                            TableColumn<XmrOfferBookListItem, XmrOfferBookListItem> column) {
    ...
    private AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> getMarketColumn() {
        AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> column = new AutoTooltipTableColumn<>(Res.get("shared.market")) {
            {
                setMinWidth(40);
            }
        };
    ...
    private AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> getPriceColumn() {
        ...
        column.setCellFactory(
                new Callback<>() {
                    ...
                    public TableCell<XmrOfferBookListItem, XmrOfferBookListItem> call(
                            TableColumn<XmrOfferBookListItem, XmrOfferBookListItem> column) {
                        return new TableCell<>() {
                            private XmrOfferBookListItem offerBookListItem;
                            ...
                            @NotNull
                            private AutoTooltipLabel getPriceLabel(String priceString, XmrOfferBookListItem item) {
    ...
    private AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> getVolumeColumn() {
        AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> column = new AutoTooltipTableColumn<>("") {
            {
                setMinWidth(125);
            }
    ...
    private AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> getPaymentMethodColumn() {
        AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> column = new AutoTooltipTableColumn<>(Res.get("shared.paymentMethod")) {
            {
                setMinWidth(80);
            }
        };
        ...
        column.setCellFactory(
                new Callback<>() {
                    @Override
                    public TableCell<XmrOfferBookListItem, XmrOfferBookListItem> call(TableColumn<XmrOfferBookListItem, XmrOfferBookListItem> column) {
                        return new TableCell<>() {
    ...
    private TableColumn<XmrOfferBookListItem, XmrOfferBookListItem> getActionColumn() {
        TableColumn<XmrOfferBookListItem, XmrOfferBookListItem> column = new AutoTooltipTableColumn<>(Res.get("shared.actions")) {
            {
                setMinWidth(200);
                setSortable(false);
            }
                ...
                new Callback<>() {
                    ...
                    public TableCell<XmrOfferBookListItem, XmrOfferBookListItem> call(TableColumn<XmrOfferBookListItem, XmrOfferBookListItem> column) {
                        return new TableCell<>() {
                            ...
                            @Override
                            public void updateItem(final XmrOfferBookListItem newItem, boolean empty) {
    ...
    private AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> getAvatarColumn() {
        AutoTooltipTableColumn<XmrOfferBookListItem, XmrOfferBookListItem> column = new AutoTooltipTableColumn<>(Res.get("offerbook.trader")) {
            {
                setMinWidth(80);
                setMaxWidth(80);
                setSortable(true);
