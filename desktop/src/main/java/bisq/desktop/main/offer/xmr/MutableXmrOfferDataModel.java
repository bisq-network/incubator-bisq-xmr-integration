...
public abstract class MutableXmrOfferDataModel extends OfferXmrDataModel implements BsqBalanceListener {
    ...
    @Inject
    public MutableXmrOfferDataModel(OpenOfferManager openOfferManager,
