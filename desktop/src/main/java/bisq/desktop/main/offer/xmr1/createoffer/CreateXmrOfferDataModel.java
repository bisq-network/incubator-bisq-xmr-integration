...
import bisq.desktop.main.offer.xmr.MutableXmrOfferDataModel;
 ...
 */
class CreateXmrOfferDataModel extends MutableXmrOfferDataModel {

    @Inject
    public CreateXmrOfferDataModel(OpenOfferManager openOfferManager,
