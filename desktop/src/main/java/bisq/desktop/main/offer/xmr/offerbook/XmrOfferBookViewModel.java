...
@Slf4j
class XmrOfferBookViewModel extends ActivatableViewModel {
    private final OpenOfferManager openOfferManager;
    private final User user;
    private final XmrOfferBook offerBook;
    ...
    private final FilteredList<XmrOfferBookListItem> filteredItems;
    private final SortedList<XmrOfferBookListItem> sortedItems;
    private final ListChangeListener<TradeCurrency> tradeCurrencyListChangeListener;
    private final ListChangeListener<XmrOfferBookListItem> filterItemsListener;
    ...
    public XmrOfferBookViewModel(User user,
        ...
        filterItemsListener = c -> {
            final Optional<XmrOfferBookListItem> highestAmountOffer = filteredItems.stream()
            ...
            final Optional<XmrOfferBookListItem> highestPriceOffer = filteredItems.stream()
            ...
            final Optional<XmrOfferBookListItem> highestMarketPriceMarginOffer = filteredItems.stream()
    ...
    SortedList<XmrOfferBookListItem> getOfferList() {
        return sortedItems;
    }
    ...
    String getAmount(XmrOfferBookListItem item) {
    ...
    String getPrice(XmrOfferBookListItem item) {
        if ((item == null))
            return "";
    ...
    String getVolume(XmrOfferBookListItem item) {
    ...
    int getNumberOfDecimalsForVolume(XmrOfferBookListItem item) {
    ...
    String getPaymentMethod(XmrOfferBookListItem item) {
        String result = "";
        if (item != null) {
    ...
    String getPaymentMethodToolTip(XmrOfferBookListItem item) {
        String result = "";
        if (item != null) {
            Offer offer = item.getOffer();
