...
public abstract class MutableXmrOfferView<M extends MutableXmrOfferViewModel> extends ActivatableViewAndModel<AnchorPane, M> {
    ...
    private OfferXmrView.CloseHandler closeHandler;
    ...
    public MutableXmrOfferView(M model,
    ...
    public void setCloseHandler(OfferXmrView.CloseHandler closeHandler) {
