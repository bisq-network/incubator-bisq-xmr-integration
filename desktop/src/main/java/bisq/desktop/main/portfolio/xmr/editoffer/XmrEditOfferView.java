...
@FxmlView
public class XmrEditOfferView extends XmrMutableOfferView<XmrEditOfferViewModel> {
    ...
    @Inject
    private XmrEditOfferView(XmrEditOfferViewModel model, Navigation navigation, Preferences preferences, Transitions transitions, OfferDetailsWindow offerDetailsWindow, XmrBSFormatter xmrFormatter, BsqFormatter bsqFormatter) {
